export const attributeTranslation = {
	...
	start_floor_glass_dencity: "Доля площади проемов к глухой поверхности стены (мин)",
	hole_proportion: "Пропорции проемов (высота к ширине)*",
	start_floor_colour_dencity: "Доля глухой поверхности фасада, окрашенной в основной цвет (мин)",
	colour_start_floor: "Основные цвета (цвет первого этажа не должен отличаться от цвета фасада, выходящего на уличный фронт)",
	...
	S_b: "Общая площадь застройки (макс)",
	S_footprint: "Площадь подошвы здания (макс)",
	S_mm: "Площадь плоскостных парковок на участке (макс)",
	S_green: "Площадь озеленения (мин)",
...
export const attributeUnits = {
	...
	start_floor_glass_dencity: "%",
	start_floor_colour_dencity: "%",
	entrance_height: "м*",
	border_height: "м",
	border_transparancy: "%",
	column_step: "м",
